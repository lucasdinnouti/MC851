...
`define LW_COMPACT_OP 5'b01000
`define LWSP_COMPACT_OP 5'b01010
`define SW_COMPACT_OP 5'b11000
`define SWSP_COMPACT_OP 5'b11010
`define ADDI_COMPACT_OP 5'b00001
`define ADDI_4SPN_COMPACT_OP 5'b00000
`define ADDI_16SP_LUI_COMPACT_OP 5'b01101
`define LI_COMPACT_OP 5'b01001
`define J_COMPACT_OP 5'b10101
`define JALR_ADD_COMPACT_OP 5'b10010
`define JAL_COMPACT_OP 5'b00101
`define BEQZ_COMPACT_OP 5'b11001
`define BNEZ_COMPACT_OP 5'b11101
`define ALU_OPS_COMPACT_OP 5'b10001
`define SLLI_COMPACT_OP 5'b00010
